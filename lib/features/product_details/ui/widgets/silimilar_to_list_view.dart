...
class SimilarTOListView extends StatelessWidget {
  ...
  const SimilarTOListView({super.key, required this.currentProductId});
        ...
        BlocBuilder<GetProductsInCategoryCubit, GetProductsInCategoryState>(
          builder: (context, state) {
            if (state is GetProductsInCategorySuccess) {
              final products = state.allProductsModel.data!.where((p) => p.productId != currentProductId).toList();
              return SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: state.allProductsModel.data!
