...
class FavouriteScreenBody extends StatelessWidget {
  final bool isGuest;
  const FavouriteScreenBody({super.key, required this.isGuest});
                          ...
                          child: Column(
                            children: [
                              ...
                              GridView.builder(
                                ...
                                itemCount: state.favouritesModel
                                        .favouriteDataList?.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  return FavouritCartItem(
                                    favouriteProductData: state.favouritesModel
                                        .favouriteDataList![index],
                                  );
                                },
                              ),
                            ],
